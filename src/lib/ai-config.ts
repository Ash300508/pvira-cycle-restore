 ...
 *
 * To move to PRODUCTION MODE, set VITE_PAVITRA_AI_MODE=production and implement
...
export const AI_MODE: AiMode =
  (import.meta.env["VITE_PAVITRA_AI_MODE"] as AiMode | undefined) === "production" ? "production" : "demo";

export const IS_DEMO_AI = AI_MODE === "demo";

/** Maps API availability is independent of the AI mode. */
export const HAS_MAP_API = Boolean(import.meta.env["VITE_PAVITRA_MAPS_KEY"]);
