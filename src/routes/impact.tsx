...
function ImpactPage() {
  return (
    <>
      <PageHeader eyebrow="Impact" title="Our collective impact" description="Live metrics from the PVIRA recovery network." />
      <Section>
